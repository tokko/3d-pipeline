...
# Configuration — port + client timeout overridable via env vars
UNREAL_HOST = os.environ.get("UNREAL_MCP_HOST", "127.0.0.1")
UNREAL_PORT = int(os.environ.get("UNREAL_MCP_PORT", "55557"))
UNREAL_CLIENT_TIMEOUT = float(os.environ.get("UE_MCP_CLIENT_TIMEOUT_SEC", "300"))
...
class UnrealConnection:
    ...
    def receive_full_response(self, sock, buffer_size=4096) -> bytes:
        ...
        chunks = []
        sock.settimeout(UNREAL_CLIENT_TIMEOUT)  # asset imports can run for minutes
        try:
            while True:
